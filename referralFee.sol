...
contract EFIKCOINReferral {
    // Fixed checksummed addresses - these will compile
    ...
    event Bought(address indexed buyer, address indexed referrer, uint256 bnbIn);
    event Donated(address indexed from, uint256 amount, string currency);

    constructor() {
        treasury = 0x676cCf34C191a9D6EFE4B265b84877C619A559d0; // Your treasury
    }
    ...
    function buyWithReferral(address _referrer) external payable {
        ...
        emit Bought(msg.sender, ref, msg.value);
    }
